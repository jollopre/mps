    ...
    return (
      <form>
        <div className="form-group">
          ...
          <Typeahead onChange={this.onChangeHandler} options={options} placeholder="Choose an option..." labelKey="name" name={`${feature.feature_type}${feature.id}`} selected={value} />
        </div>
      </form>
    );
  }
