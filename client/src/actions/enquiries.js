...
export const DELETE_ENQUIRY = asyncAction('DELETE_ENQUIRY');
...
export const deleteEnquiryCreator = (enquiryId) => ({
  type: API,
  payload: {
    url: `/api/enquiries/${enquiryId}`,
    method: 'DELETE',
    types: [DELETE_ENQUIRY.PENDING, DELETE_ENQUIRY.SUCCESS, DELETE_ENQUIRY.ERROR]
  }
});
...
export const deleteEnquiry = (enquiryId) => {
  return (dispatch) => {
    return dispatch(deleteEnquiryCreator(enquiryId));
  }
}
