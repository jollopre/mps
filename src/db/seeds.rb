...
populate_feature_options('Bag Style', ['Bottom Gusset', 'Side Gusset', 'Block Bottom', 'SOS (Self Opening Satchel', 'Unstrung'])
populate_feature_options('Handle Style', ['Patch', 'Side Gusset', 'Block Bottom', 'Vest', 'Clip Close', 'TOT (Turnover Top)', 'Twisted Paper', 'Rope', 'Sack'])
